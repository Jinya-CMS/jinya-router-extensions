...
abstract class Handlers
{
    ...
    public static function handleDeleteReferencedError(
        ...
        return self::$errorHandler->handleDeleteReferencedError($request, $deleteReferencedException) ?: new Response(
            409
        );
    }
    ...
    public static function handleInvalidDateFormatError(
        ...
        return self::$errorHandler->handleInvalidDateFormatError($request, $invalidDateFormatException) ?: new Response(400);
    }
    ...
    public static function handleCreateReferenceFailedError(
        ...
        return self::$errorHandler->handleCreateReferenceFailedError(
            $request,
            $createReferenceFailedException
        ) ?: new Response(409);
    }
    ...
    public static function handleCreateColumnIsNullError(
        ...
        return self::$errorHandler->handleCreateColumnIsNullError(
            $request,
            $createColumnIsNullException
        ) ?: new Response(400);
    }
    ...
    public static function handleCreateUniqueFailedError(
        ...
        return self::$errorHandler->handleCreateUniqueFailedError(
            $request,
            $createUniqueFailedException
        ) ?: new Response(409);
    }
    ...
    public static function handleUpdateReferenceFailedError(
        ...
        return self::$errorHandler->handleUpdateReferenceFailedError(
            $request,
            $updateReferenceFailedException
        ) ?: new Response(409);
    }
    ...
    public static function handleUpdateColumnIsNullError(
        ...
        return self::$errorHandler->handleUpdateColumnIsNullError(
            $request,
            $updateColumnIsNullException
        ) ?: new Response(400);
    }
    ...
    public static function handleUpdateUniqueFailedError(
        ...
        return self::$errorHandler->handleUpdateUniqueFailedError(
            $request,
            $updateUniqueFailedException
        ) ?: new Response(409);
    }
}
